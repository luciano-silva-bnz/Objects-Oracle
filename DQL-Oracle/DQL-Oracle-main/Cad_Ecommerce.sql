...
SELECT A.SEQPRODUTO PLU, B.CODACESSO EAN, A.DESCCOMPLETA DESCRICAO, F.MARCA, D.NOMERAZAO FORNECEDOR,
       G.STATUS STATUS_COMPRA, A.DTAHORINCLUSAO DATA_CADASTRO,
       ...
       H.ALTURA ALTURA_CM, H.LARGURA LARGURA_CM, H.PROFUNDIDADE PROFUNDIDADE_CM,-- H.QTDUNIDEMB, 
       H.MULTEQPEMB
