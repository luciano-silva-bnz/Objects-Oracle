...
SELECT ALTERAPCOVALIDRECEBTO, DTAULTALTERACAO, Z.USUULTALTERACAO, SEQFAMILIA, SEQFORNECEDOR --, Z.* 
 FROM MAC_CUSTOFORNECLOG Z 
WHERE SEQFAMILIA = 735490 AND ALTERAPCOVALIDRECEBTO = 'S' AND TO_CHAR(DTAULTALTERACAO, 'DD/MM/YYYY') = '12/04/2023'
