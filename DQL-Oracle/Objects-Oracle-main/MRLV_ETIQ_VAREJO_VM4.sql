CREATE OR REPLACE VIEW CONSINCO.MRLV_ETIQ_VAREJO_VM4 AS
...
--------- QUANDO ESTIVER NA OFERTA E QUANDO OFERTA FOI MENOR QUE PRECOO NORMAL
       ...
       CASE WHEN PRECOPPROMOCIONAL < NVL(J.PRECOVALIDPROMOC,0) AND PRECOPPROMOCIONAL > 0-- SE EXISTIR MEU NAGUMO, FORMA OFERTA + MEU NAGUMO E FOR MENOR QUE OFERTA NORMAL
